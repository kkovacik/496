...
class GtpConnection():
    ...
    #def policy_moves_cmd(self, args):
        ...
        #"""
        #moves=GoBoardUtil.generate_prob_moves(self.board)
            ...
            #for i in range(0, len(moves)):
                #response=response +' '+moves[i][0]+' '+moves[i][1]+' '
    ...
    def policy_moves_cmd(self, args):
        ...
        if len(policy_moves) == 0:
            ...
            for i in range(0, len(policy_moves)):
                ...
                response=response +' '+str(GoBoardUtil.sorted_point_string([policy_moves[i][0]], self.board.NS))+' '+str_float
    ...
    def play_cmd(self, args):
        ...
        try:
            ...
            if not self.board.move(move, color):
                ...
                #self.go_engine.update(move)   # Removed
            self.respond()
        except Exception as e:
