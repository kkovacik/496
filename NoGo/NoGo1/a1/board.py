...
def lm_capture():
    global last_move_capture
    return last_move_capture
...
class GoBoard(object):
    ...
    def check_legal(self,point,color):
        ...
        result, _=self._play_move2(point, color)
    ...
    def is_eye(self,point,color):
        '''
        we don't look for eyes in noGo
        '''
        return None
    ...
    # neighbors around point 
        ...
        # its neighbor isn't itself
            ...
            ######################
                        ...
                        c=self._point_to_coord(point)
                        # raise and capture message and don't play the move
    ...
    # plays the point on the board 
        ...
        if(num_captures > 0):
            ...
            return False, msg
                ...
                c=self._point_to_coord(point)
                msg = "Suicide"
                # generate a suicide error message 
                board_util.raise_suicide_error()
                return False, msg
    
    # created a duplicate play method that doesn't raise errors 
    # called when generating legal moves
