...
class GtpConnection():
    ...
    def __init__(self, go_engine,outfile = '/tmp/gtp_log_jmk', debug_mode = False):
        """
    ...
    def get_cmd(self, command):
        ...
        #handles color
        #if command_name == 'play' and args != [] and args[0] not in ['w','b']:
        	#print("illegal Move:", ' '.join(args), "wrong color")
	# error for wrong number of argumnets 
    ...
    def play_cmd(self, args):
        ...
        try:
            ...
            if args[1].lower()=='pass':
                ...
                self.respond("Passing is illegal")
                return
            ...
            if not self.board.move(move, color):	
                self.respond("illegal move: {} {}".format(board_color, board_move, "test"))
                return
            else:
    ...
    def genmove_cmd(self, args):
        ...
        try:
            ...
            if not self.board.check_legal(move, color):
                ...
                # Here is where the program return illegal move text, need to error check here I think
